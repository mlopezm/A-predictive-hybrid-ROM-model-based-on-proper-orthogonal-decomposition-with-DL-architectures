...
- Cilin3D_20 v2.0.ipynb: It provides an implementation of the CNN1D and LSTM models for the CircularCilinder3D dataset. It includes the initial SVD transformation. 
